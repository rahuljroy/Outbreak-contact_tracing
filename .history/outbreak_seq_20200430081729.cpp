...
int main(){
    ...
    struct timespec start1, finish, graph_start;
    double time_seq = 0;
    ...
    cout<<"Size of neighbours of 987709 is "<<day_graphs.graph_for_the_day[987709].size()<<endl;
    ...
    printf("\nTime taken for sequential code for outbreak,  is, %e", time_seq);
