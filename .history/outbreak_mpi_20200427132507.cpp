...
void get_infected(char* filename, long int no_infected, long int **infected, int day){
    long int u;
    string data;
...
int main(int argc, char** argv){
    ...
    char* file;
    long int no_vertices=0, per_process, start, end, initial_infected=0;
    ...
    get_infected(file, initial_infected,, day, myrank);
