...
void get_neighbours(vector< vector<long int> > graph, long int u, vector< vector<long int> >& neighbours, vector<int>& quarantined){
...
int main(){
    ...
    vector<int> infected_or_not, prev_infected, processed, quarantined, infected_flag, quarantined_flag;
    set<int> indices;
