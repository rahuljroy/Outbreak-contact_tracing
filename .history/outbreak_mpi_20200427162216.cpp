...
int main(int argc, char** argv){
    ...
    char* file;
    long int no_vertices=0, per_process, start, end, initial_infected=0, current_infected=0, neighbour_size;
    ...
    int infected_or_not[no_vertices], quarantined[no_vertices];
